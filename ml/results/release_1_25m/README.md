...
- `eval_5k_all_bots.json`: raw 5000-game paired fixed-deck DART-vs-bot results.
- `wr_matrix_rulebots_5k.json`: 5000-game rule-bot round-robin matrix used as the Glicko base.
