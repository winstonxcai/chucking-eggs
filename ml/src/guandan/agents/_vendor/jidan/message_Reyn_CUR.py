...
def get_opp_VAL(card,curRank):
    if card[0] == 'Single':
        pass  #print('Reyn_AI Tip 确认敌人Action为Single形式')
        val = 0
        val += get_point_val(card[2][0],curRank)
        #print('Reyn_AI Tip 敌人的出牌权值为',val)
        return val
    if card[0] == 'Pair':
        pass  #print('Reyn_AI Tip 确认敌人Action为Pair形式')
        val = 20
        val += get_point_val(card[2][0],curRank)
        ...
        return val
    if card[0] == 'Trips':
        pass  #print('Reyn_AI Tip 确认敌人Action为Trips形式')
        val = 100
        val += get_point_val(card[2][0],curRank)
        val += get_point_val(card[2][1],curRank)
    ...
    if card[0] == 'Bomb' and len(card[2]) == 4:
        pass  #print('Reyn_AI Tip 确认敌人Action为Bomb_4形式')
        val = get_point_val(card[2][0],curRank)
        val += get_point_val(card[2][1],curRank)
        val += get_point_val(card[2][2],curRank)
    ...
    if card[0] == 'Bomb' and len(card[2]) == 5:
        pass  #print('Reyn_AI Tip 确认敌人Action为Bomb形式')
        val = get_point_val(card[2][0],curRank)
        val += get_point_val(card[2][1],curRank)
        val += get_point_val(card[2][2],curRank)
        val += get_point_val(card[2][3],curRank)
        ...
        return val
    if card[0] == 'Straight':
        pass  #print('Reyn_AI Tip 确认敌人Action为Straight形式')
        val = get_point_val(card[2][0],curRank)
        val += get_point_val(card[2][1],curRank)
        val += get_point_val(card[2][2],curRank)
        val += get_point_val(card[2][3],curRank)
    ...
    if card[0] == 'ThreeWithTwo':
        pass  #print('Reyn_AI Tip 确认敌人Action为ThreeWithTwo形式')
        val = get_point_val(card[2][0],curRank)
        val += get_point_val(card[2][1],curRank)
        val += get_point_val(card[2][2],curRank)
        val += get_point_val(card[2][3],curRank)
        ...
        return val
    if card[0] == 'ThreePair':
        pass  #print('Reyn_AI Tip 确认敌人Action为ThreePair形式')
        val = get_point_val(card[2][0],curRank)
        val += get_point_val(card[2][1],curRank)
        val += get_point_val(card[2][2],curRank)
        val += get_point_val(card[2][3],curRank)
        ...
        return val
    if card[0] == 'TwoTrips':
        pass  #print('Reyn_AI Tip 确认敌人Action为TwoTrips形式')
        val = get_point_val(card[2][0],curRank)
        val += get_point_val(card[2][1],curRank)
        val += get_point_val(card[2][2],curRank)
        val += get_point_val(card[2][3],curRank)
    ...
    if card[0] == 'StraightFlush':
        pass  #print('Reyn_AI Tip 确认敌人Action为StraightFlush形式')
        val = get_point_val(card[2][0],curRank)
        val += get_point_val(card[2][1],curRank)
        val += get_point_val(card[2][2],curRank)
        val += get_point_val(card[2][3],curRank)
...
def get_VAL(handCards_S,handCards_H,handCards_C,handCards_D,handCards_A,handCards_R,handCards_K,card,curRank):
    ...
    if card[0] == 'PASS':
        return -99999
    if card[0] == 'Single':
        pass  #print('Reyn_AI Tip 确认该Action为Single形式')
        val = 100
        val -= get_point_val(card[2][0],curRank)
        ...
        return val
    if card[0] == 'Pair':
        pass  #print('Reyn_AI Tip 确认该Action为Pair形式')
        val = 100
        val -= get_point_val(card[2][0],curRank)
        val -= get_point_val(card[2][1],curRank)
        #print('Reyn_AI Tip 由于该出牌行动,权值目前为',val)
        ...
        return val
    if card[0] == 'Trips':
        pass  #print('Reyn_AI Tip 确认该Action为Trips形式')
        val = 80
        val -= get_point_val(card[2][0],curRank)
        val -= get_point_val(card[2][1],curRank)
        val -= get_point_val(card[2][2],curRank)
        ...
        return val
    if card[0] == 'Bomb' and len(card[2]) == 4:
        pass  #print('Reyn_AI Tip 确认该Action为Bomb_4形式')
        val = -get_point_val(card[2][0],curRank)
        val -= get_point_val(card[2][1],curRank)
        val -= get_point_val(card[2][2],curRank)
        val -= get_point_val(card[2][3],curRank)
        ...
        return val
    if card[0] == 'Bomb' and len(card[2]) == 5:
        pass  #print('Reyn_AI Tip 确认该Action为Bomb形式')
        val = -get_point_val(card[2][0],curRank)
        val -= get_point_val(card[2][1],curRank)
        val -= get_point_val(card[2][2],curRank)
        val -= get_point_val(card[2][3],curRank)
        ...
        return val
    if card[0] == 'Straight':
        pass  #print('Reyn_AI Tip 确认该Action为Straight形式')
        val = -get_point_val(card[2][0],curRank)
        val -= get_point_val(card[2][1],curRank)
        val -= get_point_val(card[2][2],curRank)
        val -= get_point_val(card[2][3],curRank)
        ...
        return val
    if card[0] == 'ThreeWithTwo':
        pass  #print('Reyn_AI Tip 确认该Action为ThreeWithTwo形式')
        val = -get_point_val(card[2][0],curRank)
        val -= get_point_val(card[2][1],curRank)
        val -= get_point_val(card[2][2],curRank)
        val -= get_point_val(card[2][3],curRank)
        ...
        return val
    if card[0] == 'ThreePair':
        pass  #print('Reyn_AI Tip 确认该Action为ThreePair形式')
        val = -get_point_val(card[2][0],curRank)
        val -= get_point_val(card[2][1],curRank)
        val -= get_point_val(card[2][2],curRank)
        val -= get_point_val(card[2][3],curRank)
        ...
        return val
    if card[0] == 'TwoTrips':
        pass  #print('Reyn_AI Tip 确认该Action为TwoTrips形式')
        val = -get_point_val(card[2][0],curRank)
        val -= get_point_val(card[2][1],curRank)
        val -= get_point_val(card[2][2],curRank)
        val -= get_point_val(card[2][3],curRank)
        ...
        return val
    if card[0] == 'StraightFlush':
        pass  #print('Reyn_AI Tip 确认该Action为StraightFlush形式')
        val = -get_point_val(card[2][0],curRank)
        val -= get_point_val(card[2][1],curRank)
        val -= get_point_val(card[2][2],curRank)
        val -= get_point_val(card[2][3],curRank)
...
def check_message(message,pos):
    ...
    if message['greaterPos']==pos or message['greaterPos']==-1:
        pass  #print('Reyn_AI Tip 轮到我方先手出牌')
        #开始遍历Actionlist
        index = -1
        #创建空操作权重列表[权重值]
        value = []
    ...
    if message['greaterPos']==(pos+2)%4:
        ...
        pass  #print('Reyn_AI Tip 轮到我方迎接敌人')
        check_pass=True
