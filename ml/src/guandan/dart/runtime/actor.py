...
from ..model.q_network import DartQNet, SharedHeadQNet, SharedTrickHeadQNet
...
def argmax_q(
    net: DartQNet | SharedHeadQNet | SharedTrickHeadQNet,
...
def play_episode(
    q_nets: Mapping[int, DartQNet] | SharedHeadQNet | SharedTrickHeadQNet | None,
...
def make_scorer(
    q_nets: Mapping[int, DartQNet] | SharedHeadQNet | SharedTrickHeadQNet,
    encoder: StateActionEncoder | RoleAwareStateActionEncoder,
