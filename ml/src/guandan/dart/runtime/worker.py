...
def actor_loop(
    ...
    _log_run_dir = Path(run_dir) if run_dir is not None else Path("/tmp/dart_actor_logs")
    ...
    while not stop_event.is_set():
        ...
        # Set DART_NO_RUST=1 to force the Python path (e.g. for benchmarking).
        _use_rust = (
            _RUST_AVAILABLE
            ...
            and not os.environ.get("DART_NO_RUST")
        )
