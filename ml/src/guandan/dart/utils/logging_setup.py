"""Logging configuration for Dart training runs.
...
``DART_STREAM_LOGS=1`` env-var is set) — writes INFO-and-above through
...
def setup_run_logging(
    ...
    ``stream_to_stdout`` defaults to the ``DART_STREAM_LOGS=1`` env-var
    ...
    if stream_to_stdout is None:
        stream_to_stdout = os.environ.get("DART_STREAM_LOGS") == "1"
