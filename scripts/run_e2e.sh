...
# Usage:
#   ./scripts/run_e2e.sh                          # run all stages
#   ./scripts/run_e2e.sh --skip-test               # skip tests
#   ./scripts/run_e2e.sh --skip-train              # skip training
#   ./scripts/run_e2e.sh --test-only               # alias for --skip-train
#   ./scripts/run_e2e.sh --train-only              # alias for --skip-test
#   ./scripts/run_e2e.sh --modal                   # train on Modal GPU
#   ./scripts/run_e2e.sh --eval-only checkpoint.pt # evaluate a checkpoint
