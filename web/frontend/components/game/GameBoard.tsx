      ...
      <div className="flex-1 flex flex-col p-[5px] lg:px-6 lg:pt-2 lg:pb-1 gap-0 relative lg:justify-center">
        ...
        <div className="flex-1 flex items-start lg:items-center justify-center min-h-0">
          <div className="grid grid-cols-3 grid-rows-[auto_1fr] lg:grid-cols-[auto_minmax(0,768px)_auto] lg:grid-rows-[auto_auto] gap-x-1 gap-y-3 lg:gap-x-4 lg:gap-y-10 items-start lg:items-center justify-items-center w-full h-full lg:h-auto">
            ...
            {/* Left opponent */}
            <div className="col-start-1 row-start-1 lg:row-start-2 h-7 overflow-visible lg:h-auto">
              {leftOpp && (
            ...
            {/* Right opponent */}
            <div className="col-start-3 row-start-1 lg:row-start-2 h-7 overflow-visible lg:h-auto">
              {rightOpp && (
